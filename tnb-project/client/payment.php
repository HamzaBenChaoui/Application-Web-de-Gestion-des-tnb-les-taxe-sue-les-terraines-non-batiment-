...
<body>
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Effectuez vos tâches de paiement en toute simplicité. J'espère que vous êtes satisfait de nos services - bienvenue </span>
    </div>
    <div class="landing">
        <div class="container">
            <h1 class="text-center mt-2 mb-5">L'option de payment</h1>
            <div class="row m-0 align-items-center justify-content-center">
                <div class="col-md-6 d-flex justify-content-center align-items-center gap-2">
                    <a href="cart_paye.php">
